...
from tools.sthread import stop_thread
from tools.client_gui import ChatWindow
from rsa import PublicKey
from tools.initial_window import LoginWindow
...
class ChatWindowGUI(ChatWindow):

    def __init__(self, Client, ADDR, name):
        super(ChatWindowGUI, self).__init__()
        self.client = Client
        self.addr = ADDR
        self.name = name
        self.pub_keys = {}
...
if state:
    ...
    chat_room = ChatWindowGUI(udpCliSock, ADDR, NAME)
